...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Oct 10 14:46:02 CST 2015
  */
public class SequencesParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\002\004\003\000\002\006\004\000\002\006\005\000" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\uffff\001\002\000\004\002\030\001\002\000\006\003\007" +
    "\006\010\001\002\000\010\003\ufffb\005\ufffb\006\ufffb\001" +
    "\002\000\006\011\020\013\015\001\002\000\010\003\007" +
    "\005\ufffe\006\010\001\002\000\004\005\013\001\002\000" +
    "\004\002\000\001\002\000\004\005\ufffd\001\002\000\004" +
    "\012\026\001\002\000\004\010\024\001\002\000\004\007" +
    "\023\001\002\000\004\012\021\001\002\000\004\014\022" +
    "\001\002\000\004\010\ufff8\001\002\000\010\003\ufffc\005" +
    "\ufffc\006\ufffc\001\002\000\010\007\ufffa\011\020\013\015" +
    "\001\002\000\004\007\ufff9\001\002\000\004\015\027\001" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\002\001\001\000\006\003\011\004\010\001\001\000\002" +
    "\001\001\000\006\005\015\006\016\001\001\000\006\003" +
    "\013\004\010\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\006\005\015\006\024\001" +
  ...
  public final java_cup.runtime.Symbol CUP$SequencesParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$SequencesParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // scenario_attr ::= ORDER EQUAL INT 
            {
		...
		Integer value = (Integer)((java_cup.runtime.Symbol) CUP$SequencesParser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // scenario_attr ::= NAME EQUAL ID 
            {
              GenericAttr RESULT =null;
		int valueleft = ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()).left;
		int valueright = ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()).right;
		String value = (String)((java_cup.runtime.Symbol) CUP$SequencesParser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // scenario_attrs ::= scenario_attr SEMICOLON scenario_attrs 
            {
		...
		GenericElement attrs = (GenericElement)((java_cup.runtime.Symbol) CUP$SequencesParser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // scenario_attrs ::= scenario_attr SEMICOLON 
            {
              GenericElement RESULT =null;
		...
		GenericAttr attr = (GenericAttr)((java_cup.runtime.Symbol) CUP$SequencesParser$stack.elementAt(CUP$SequencesParser$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // sequences_element ::= error 
            {
              Object RESULT =null;

              CUP$SequencesParser$result = parser.getSymbolFactory().newSymbol("sequences_element",2, ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()), RESULT);
            }
          return CUP$SequencesParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // sequences_element ::= INIT_SCENARIO scenario_attrs MORE_THAN_S 
            {
              Object RESULT =null;
    ...
    if(this.parser.sequences.size() == 0) {
        ...
        for(int index = 0; index < this.parser.sequences.size(); index++){
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // sequences_elements ::= sequences_element sequences_elements 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // sequences_elements ::= sequences_element 
            {
              Object RESULT =null;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // sequences ::= error 
            {
              Object RESULT =null;

              CUP$SequencesParser$result = parser.getSymbolFactory().newSymbol("sequences",0, ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$SequencesParser$stack.peek()), RESULT);
            }
          return CUP$SequencesParser$result;
