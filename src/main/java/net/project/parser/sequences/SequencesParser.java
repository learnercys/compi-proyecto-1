...
class CUP$SequencesParser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$SequencesParser$do_action_part00000000(
    ...
    if(this.parser.sequences.size() == 0) {
		...
		Integer value = (Integer)((java_cup.runtime.Symbol) CUP$SequencesParser$stack.peek()).value;
          ...
          default:
            throw new Exception(
               "Invalid action number "+CUP$SequencesParser$act_num+"found in internal parse table");
  ...
  public final java_cup.runtime.Symbol CUP$SequencesParser$do_action(
    ...
    throws java.lang.Exception
    {
              return CUP$SequencesParser$do_action_part00000000(
                               CUP$SequencesParser$act_num,
                               CUP$SequencesParser$parser,
                               CUP$SequencesParser$stack,
                               CUP$SequencesParser$top);
    }
}
